...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'bit studio bit studio bit studio bit studio bit studio'
...
def testModel():
    ...
    with tf.Session() as sess:
        ...
        @app.route("/bad")
        def bad():
            return "<h1><center> ความสุภาพ = " + str(sentence2Prop[-1][0]) + " % <br><br> ความหยาบคาย = " + str(
                sentence2Prop[-1][
                    1]) + " % <br><br> Machine says: ประโยคที่ท่านส่งมาหยาบคาย! <br> <a href=' " + myWebUrl_ + "sender'>back to sender</a> </center></h1>"

        @app.route("/good")
        def good():
            return "<h1><center> ความสุภาพ = " + str(sentence2Prop[-1][0]) + " % <br><br> ความหยาบคาย = " + str(
                sentence2Prop[-1][
                    1]) + " % <br><br> Machine says: ประโยคที่ท่านส่งมาสุภาพ! <br> <a href=' " + myWebUrl_ + "sender'>back to sender</a> </center></h1>"
                        ...
                        <html>
                          ...
                          <body>
                            ...
                            <form action=" ''' + myWebUrl_ + '''sender" method="post">
                                ...
                                <input type="submit"> 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999<br><br>
